...
//                Method getter = new PropertyDescriptor("periods", zgif.getClass()).getReadMethod();
//
//                Map<String, Period<AbstractDataRoot>> periods = (Map<String, Period<AbstractDataRoot>>) getter.invoke(zgif);
//                Period<AbstractDataRoot> period = periods.get(periodIdentifier);
//                root = period.getData();
//            } else {
//                Method getter = new PropertyDescriptor("data", zgif.getClass()).getReadMethod();
//                root = (AbstractDataRoot) getter.invoke(zgif);
//            }
//
//            Information.getHierarchicalParentClassesOfNode(root.getClass(), object.getClass());
//
////            Iterator<Class<?>> parentIterator = Arrays.asList(Information.getParentClassesOfNode(object.getClass())).iterator();
//
...
//                List<Field> nodeListFields = new NodeInformation(curParent.getClass()).getNodeLists();
//
//                curParent = null;
...
//    }
//
//    private List<AbstractNode> getParentPath(AbstractNode curParent, Node object, CSVLine<Node> csvLine) throws IntrospectionException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
