 ...
 */
 ...
 this.type = type;
        ...
        /**
         * method connects the zgif object from
         * <code>NodeConverterDescriptor</code> with the converted node object
         * of the csvLine
         *
         * @author phoudek
         * @param object
  ...
  public void connectObjectWithZGif(Node object, CSVLine<Node> csvLine) {
            try {
                ...
                if (periodIdentifier != null && !periodIdentifier.isEmpty()) {
                    ...
                    Map<String, Period<AbstractDataRoot>> periods = (Map<String, Period<AbstractDataRoot>>) getter
                            .invoke(zgif);
                ...
                while (curParent != null) {
                    ...
                    for (Field nodeListField : nodeListFields) {
                        ...
                        if (typeName.endsWith(nextParentClass.getSimpleName().replaceFirst("Abstract", ""))) {
                            ...
                            Map<String, AbstractNode> listOfNodes = (Map<String, AbstractNode>) getListMethod
                                    .invoke(curParent);
