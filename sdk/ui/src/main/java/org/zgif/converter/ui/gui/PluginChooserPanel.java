...
public class PluginChooserPanel extends JPanel {
    ...
    public PluginChooserPanel(PluginChooserType type) {
        ...
        this.add(new JLabel(word + "-Plugin:"), new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
                GridBagConstraints.NONE, new Insets(4, 4, 4, 4), 0, 0));
        this.add(new JComboBox<Object>(list), new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.CENTER,
        ...
        if (type == PluginChooserType.IMPORT) {
            ...
            this.add(x, new GridBagConstraints(0, 1, 2, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(4, 4, 4, 4), 0, 0));
        } else {
            this.add(new JLabel("" + word + "-Plugin wird geladen..."), new GridBagConstraints(0, 1, 2, 1, 1, 1,
