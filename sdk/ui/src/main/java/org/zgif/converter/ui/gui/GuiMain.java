    ...
    public static void main(String[] args) {
        ...
        menue.addSubsetChangedListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // System.out.println(((SubsetComboBox)
                // e.getSource()).getSelectedSubset());
            }
        });
        mainFrame.add(menue, BorderLayout.NORTH);
        JSplitPane sp = new JSplitPane(JSplitPane.VERTICAL_SPLIT, new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
                new PluginChooserPanel(PluginChooserType.IMPORT), new PluginChooserPanel(PluginChooserType.EXPORT)),
                new JLabel("..."));
